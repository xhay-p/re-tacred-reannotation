...
from retacred_loss_functions import HierarchicalDistanceLoss
...
class REModel(nn.Module):
    def __init__(self, args, config):
        ...
        if args.hier_loss:
            print("Loss Function :: Hierarchical Loss")
            opt = dict()
            opt['lca'] = args.lca
            if args.lca:
                print("Hierarchical Distance :: LCA")
            opt['hier_normalise'] = args.hier_normalise 
            self.loss_fnt = HierarchicalDistanceLoss(opt)
        else:
