...
from pytorch_pretrained_bert.retacred_modeling import BertForSequenceClassification
from pytorch_pretrained_bert.tokenization import BertTokenizer
from pytorch_pretrained_bert.optimization import BertAdam, warmup_linear
from pytorch_pretrained_bert.utils import retacred_constant as constant
from pytorch_pretrained_bert.utils import retacred_hierarchy as hierarchy
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hier_normalise', type=float, default=1.0, help="Normalise Hierarchical Distance loss")
