...
class PositionAwareRNN(nn.Module):
    ...
    def zero_state(self, batch_size):         
        state_shape = (self.opt['num_layers'] * 2, batch_size, self.opt['hidden_dim'])  # * 2 for BiLSTM
    ...
    def forward(self, inputs):
        ...
        hidden = self.drop(ht) # get the outmost layer h_n
