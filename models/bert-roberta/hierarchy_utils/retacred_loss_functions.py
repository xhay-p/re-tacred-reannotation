...
from .utils import retacred_hierarchy as hierarchy
...
class HierarchicalDistanceLoss(torch.nn.Module):
    ...
    def get_hierarchical_dist(self, pred, gold):
        """
            ...
            alpha = 1, 0.5, 0.2, 0.1
        """
        return self.DIS_MATRIX[gold, pred] + self.opt['alpha']
    ...
    def get_pred_lca_dist(self, pred, gold):
        """
            ...
            alpha = 1, 0.5, 0.2, 0.1
        """
        return self.DIS_MATRIX[gold, self.LCA_MATRIX[gold, pred]] + self.opt['alpha']
